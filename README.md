...
Un aspecto importante es el intervalo de tiempo entre la adquisición del seguro y la denuncia del accidente. En general, suele transcurrir mas de 30 días, antes de que se reporte el accidente a la aseguradora. Al analizar los incidentes fraudulentos, se observó que estos ocurren con mayor frecuencia en vehículos que tienen entre 5 y 7 años, y en la mayoría de casos no se realizó una denuncia policial ni se contó con testigos. Además, todos los casos de fraude fueron llevados a cabo por personas externas, es decir fraudes en los que el seguro es engañado por personas independientes. El responsable del fraude en todos los casos fue el titular de la póliza, lo que indica un intento deliberado de defraudar a la compañía aseguradora. 

<img src="R/Analisis cuantitativo.png" width="60%" />

<img src="R/graficos cualitativos.png" width="60%" />
...
<img src="R/cluster.png" width="60%" />
